...
<template>
  <StoryChapter
    chapter-number="II"
    chapter-label="BUDAYA"
    variant="focus"
    :data-chapter="2"
  >
    <div class="parallax-img reveal-up w-[min(60vw,560px)] h-[50vh]">
      <img
        src="/images/budaya/kraton.jpg"
        alt="Pusaka Budaya Yogyakarta"
        width="800"
        height="600"
        loading="lazy"
        decoding="async"
